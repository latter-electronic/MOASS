...
export default function JiraIssueCard() {
    return (
        <div className="flex flex-col mt-2 bg-white rounded-lg shadow p-3 px-5 gap-1 text-base">
            ...
            <div className="font-medium text-lg text-gray-700">Electron 개발 초기 환경 테스트</div>
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2 mt-1">
                    ...
                    <img src={mediumIcon} alt="중간중요도" className="size-6"/>
                    <img src={profileImg} alt="지라프로필1" className="rounded-full size-10" />
                </div>
            </div>
